...
class Lidar(BulletSensor[np.ndarray]):
    @dataclass
    class Config:
        accuracy: float
        rays: int
...
class RGBCamera(BulletSensor[np.ndarray]):
    @dataclass
    class Config:
        width: int
        height: int
...
class AccelerationSensor(BulletSensor[np.ndarray]):
    @dataclass
    class Config:
        time_delta: float
...
class VelocitySensor(BulletSensor[np.ndarray]):
    @dataclass
    class Config:
        gaussian_noise: float
...
class PoseSensor(BulletSensor[np.ndarray]):
    @dataclass
    class Config:
